...
urlpatterns = [
    ...
    url(r'^dancer/add_to_team/(?P<dancerId>[0-9]+)/$', views.DancerProfileView.hidden_add_form_handler),
    url(r'^dancer/remove_from_team/(?P<dancerId>[0-9]+)/$', views.DancerProfileView.hidden_remove_form_handler),
