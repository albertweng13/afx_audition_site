...
urlpatterns = [
    ...
    url(r'^notauthorized/$', views.not_authorized),
    url(r'^signup/', views.DancerSignUpView.as_view()),
    url(r'^all/', views.all),
    url(r'^all_CSV/', views.allCSV),
    url(r'^howto/', views.help_page),
    ...
    url(r'^team/$', views.AllSetTeamView.as_view()),
    # url(r'^dancer/', DancerIdView.as_view()),
    url(r'^successsignup/(?P<id>[0-9]+)/$', views.dancerId),
    url(r'^team/csv/(?P<teamId>[0-9]+)/', views.viewTeamCSV),
    url(r'^all_dancers/csv/(?P<hide>[a-z]+)/', views.viewAllCSVFiltered),
    url(r'^all_dancers/csv/$', views.viewAllDancersCSV),
    url(r'^all_dancers/show/(?P<hide>[a-z]+)/$', views.allDancersFiltered),
